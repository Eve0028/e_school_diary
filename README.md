...
### Realization:
The entire project was written in HTML5, CSS3 and PHP. All information about the school, teachers, parents, students and more is stored in the MySql database. The website is connected to the database via the PDO interface.
